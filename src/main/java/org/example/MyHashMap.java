 ...
 * @param <V>
 */
public class MyHashMap<K, V> implements Iterable<MyHashMap.Entity> {


    @Override
    public Iterator<MyHashMap.Entity> iterator() {
        return new HashMapIterator();
    }

    class HashMapIterator implements Iterator<MyHashMap.Entity>{
